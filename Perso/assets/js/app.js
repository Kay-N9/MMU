...
const selectP = document.querySelectorAll('.select-item');
...
window.addEventListener("load", () =>{
    ...
    TL
    .staggerFrom(puces, 0.8, {opacity: 0, ease: "power2.out"}, 0.1)
    .staggerFrom(selectP, 0.8, {opacity: 0, ease: "power2.out"}, 0.2)
...
// Fonction pour la selection des personnages

function changePerso(fileName){
    var img = document.querySelector("#big");
    img.setAttribute("src", fileName);
}

function selectPerso(fileName){
